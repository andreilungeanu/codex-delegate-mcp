...
- 🧑‍🤝‍🧑 **Several at once** — delegations run in parallel: fan a question out across models, or put independent workers on independent directories. Overlapping workspaces warn, because two agents writing one tree overwrite each other.
